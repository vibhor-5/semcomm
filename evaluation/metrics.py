...
def compute_lpips(orig: torch.Tensor, recon: torch.Tensor, device, lpips_model=None) -> float:
...
def measure_sampling_time_gpu(decoder, latent: torch.Tensor, token: torch.Tensor,
