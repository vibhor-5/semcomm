...
def plot_rate_semantic_curve(
    results: list[dict], baseline_results: list[dict], save_path: str
):
    ...
    for res in baseline_results:
        plt.plot(
            res["bpp"], res["clip"], linestyle="--", marker="x", label=res["model_name"]
        )
    plt.legend()
    save_plot(save_path)
